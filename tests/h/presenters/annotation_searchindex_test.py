...
@pytest.mark.usefixtures('DocumentSearchIndexPresenter', 'moderation_service')
class TestAnnotationSearchIndexPresenter(object):
    ...
    def test_it_marks_annotation_hidden_when_it_and_all_children_are_moderated(self, pyramid_request, moderation_service):
        thread_ids = ['thread-id-1', 'thread-id-2']
        annotation = mock.MagicMock(
            userid='acct:luke@hypothes.is',
            thread_ids=thread_ids)
    ...
    def test_it_does_not_mark_annotation_hidden_when_it_is_not_moderated(self, pyramid_request, moderation_service):
        thread_ids = ['thread-id-1', 'thread-id-2']
        annotation = mock.MagicMock(
            userid='acct:luke@hypothes.is',
            thread_ids=thread_ids)
    ...
    def test_it_does_not_mark_annotation_hidden_when_children_are_not_moderated(self, pyramid_request, moderation_service):
        thread_ids = ['thread-id-1', 'thread-id-2']
        annotation = mock.MagicMock(
            userid='acct:luke@hypothes.is',
            thread_ids=['thread-id-1', 'thread-id-2'])
    ...
    def test_it_does_not_mark_annotation_hidden_when_it_has_no_replies(self, pyramid_request):
        thread_ids = []
        annotation = mock.MagicMock(
            userid='acct:luke@hypothes.is',
            thread_ids=thread_ids)
